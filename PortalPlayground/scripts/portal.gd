...
func _process(_delta: float) -> void:
	...
	portal_camera.transform = global_transform * target_portal.global_transform.affine_inverse() * Global.player_camera.global_transform
	...
	if not player.ported and player_to_portal_distance < 1.3 and current_side != player_last_side:
		teleport_player()
		player.ported = true
...
func get_player_side() -> bool:
	...
	var to_camera = Global.player_camera.global_transform.origin - global_transform.origin
	return portal_normal.dot(to_camera) >= 0.0


# --- Teleport ---
func teleport_player():
	var player_root = Global.player_camera.get_parent().get_parent()
	...
	portal_camera.transform = global_transform * target_portal.global_transform.affine_inverse() * Global.player_camera.global_transform
	target_portal.portal_camera.transform = target_portal.global_transform * global_transform.affine_inverse() * Global.player_camera.global_transform
